...
const CourseInfoPage = () => {
  return (
    <div className="relative h-screen w-full font-sans bg-[#eef5fc] overflow-hidden flex flex-col">
      {/* Official Blue & White Bubble Background Layer */}
      ...
      <div className="relative z-10 flex flex-col h-full px-6 py-3 md:px-10 md:py-4 max-w-[90rem] mx-auto w-full">
        ...
        <div className="flex flex-row justify-between items-center w-full mb-3 lg:mb-4 shrink-0">
          {/* Left Side: Logo & Online Platform */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-8 flex-grow min-h-0 pb-1">
          ...
          <div className="flex flex-col h-full min-h-0">
            <div className="group flex flex-col flex-grow bg-white hover:bg-student-yellow transition-colors duration-300 rounded-[2rem] p-5 lg:p-6 shadow-[0_10px_30px_rgba(0,0,0,0.08)] items-center text-center cursor-default overflow-hidden">
              {/* Uniform Fixed-Height Icon Container */}
              <div className="h-[4.5rem] lg:h-[5.5rem] xl:h-[7rem] w-full flex items-end justify-center mb-3 lg:mb-4 shrink-0">
                <img
                  src="https://i.postimg.cc/LssD8BWw/Agregar-algo-de-texto-(14).png"
                  alt="Inmersión Total Icon"
                  /* Increased translate-y to push the icon down further to match the globe */
              ...
              {/* Subtitle & Title */}
              <p className="text-[10px] lg:text-[11px] xl:text-xs font-bold text-outloud-blue font-montserrat mb-1 shrink-0">
                ¿CÓMO FUNCIONA EL CURSO?
              </p>
              <h3 className="text-xl lg:text-3xl xl:text-[2rem] font-black text-outloud-blue font-tabarra mb-1 lg:mb-2 leading-none shrink-0">
                INMERSIÓN TOTAL
              </h3>
            ...
            <button className="mt-3 lg:mt-4 w-full rounded-full border-[2.5px] border-dashed border-outloud-blue px-4 py-2 lg:py-3 text-xs lg:text-sm font-extrabold text-outloud-blue transition-all duration-300 hover:bg-student-yellow hover:border-solid hover:border-student-yellow shadow-sm hover:shadow-md uppercase shrink-0">
            ...
            <div className="group flex flex-col flex-grow bg-white hover:bg-student-yellow transition-colors duration-300 rounded-[2rem] p-5 lg:p-6 shadow-[0_10px_30px_rgba(0,0,0,0.08)] items-center text-center cursor-default overflow-hidden">
              ...
              <div className="h-[4.5rem] lg:h-[5.5rem] xl:h-[7rem] w-full flex items-end justify-center mb-3 lg:mb-4 shrink-0">
                <img
                  ...
                  /* Increased translate-y to push the icon down further */
          ...
          <div className="flex flex-col h-full min-h-0">
            <div className="group flex flex-col flex-grow bg-white hover:bg-student-yellow transition-colors duration-300 rounded-[2rem] p-5 lg:p-6 shadow-[0_10px_30px_rgba(0,0,0,0.08)] items-center text-center cursor-default overflow-hidden">
              {/* Uniform Fixed-Height Icon Container - Left at baseline */}
              <div className="h-[4.5rem] lg:h-[5.5rem] xl:h-[7rem] w-full flex items-end justify-center mb-3 lg:mb-4 shrink-0">
                <img
              ...
              <h3 className="text-xl lg:text-3xl xl:text-[2rem] font-black text-outloud-blue font-tabarra mb-1 lg:mb-2 leading-none whitespace-pre-line shrink-0">
                CLASES 100%{'\n'}EN VIVO
              </h3>
